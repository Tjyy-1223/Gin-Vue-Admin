<template>
    <!-- PC 端显示 -->
    <div class="mx-4 mt-12 hidden text-center text-dark lg:block">
        <h1 class="text-3xl">
            {{ article.title }}
        </h1>
        <p class="f-c-c py-2">
    ...
    <!-- 移动端显示 -->
    <div class="mx-4 mt-12 block text-left text-dark lg:hidden space-y-1.5">
        <h1 class="text-2xl">
            {{ article.title }}
        </h1>
...
// 删除 HTML 标签
// 定义了一个名为 deleteHTMLTag 的函数，其目的是从输入的字符串中删除 HTML 标签和一些特定的字符。
